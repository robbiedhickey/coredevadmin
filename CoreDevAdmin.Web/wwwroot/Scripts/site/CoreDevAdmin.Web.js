...
(function (CoreDevAdmin) {
    ...
    })(Administration = CoreDevAdmin.Administration || (CoreDevAdmin.Administration = {}));
...
(function (CoreDevAdmin) {
    ...
    })(BasicSamples = CoreDevAdmin.BasicSamples || (CoreDevAdmin.BasicSamples = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoreDevAdmin.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = CoreDevAdmin.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoreDevAdmin.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (CoreDevAdmin) {
    ...
    })(Common = CoreDevAdmin.Common || (CoreDevAdmin.Common = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Common;
...
(function (CoreDevAdmin) {
    ...
    })(Membership = CoreDevAdmin.Membership || (CoreDevAdmin.Membership = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Membership;
...
(function (CoreDevAdmin) {
    ...
    })(Northwind = CoreDevAdmin.Northwind || (CoreDevAdmin.Northwind = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Northwind;
...
(function (CoreDevAdmin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'CoreDevAdmin.Northwind.Gender', 'CoreDevAdmin.Northwind.Entities.Gender');
    })(Northwind = CoreDevAdmin.Northwind || (CoreDevAdmin.Northwind = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
...
(function (CoreDevAdmin) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = CoreDevAdmin.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = CoreDevAdmin.LanguageList || (CoreDevAdmin.LanguageList = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
...
(function (CoreDevAdmin) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('CoreDevAdmin');
        Serenity.EntityDialog.defaultLanguageList = CoreDevAdmin.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = CoreDevAdmin.ScriptInitialization || (CoreDevAdmin.ScriptInitialization = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Administration;
...
(function (CoreDevAdmin) {
    ...
    CoreDevAdmin.BasicProgressDialog = BasicProgressDialog;
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new CoreDevAdmin.BasicProgressDialog();
...
(function (CoreDevAdmin) {
    ...
    })(DialogUtils = CoreDevAdmin.DialogUtils || (CoreDevAdmin.DialogUtils = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Common;
...
(function (CoreDevAdmin) {
    ...
    CoreDevAdmin.StaticTextBlock = StaticTextBlock;
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CoreDevAdmin.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(CoreDevAdmin.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(CoreDevAdmin.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(CoreDevAdmin.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        CoreDevAdmin.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: CoreDevAdmin.Authorization.userDefinition.DisplayName,
...
(function (CoreDevAdmin) {
    ...
    (function (Northwind) {
        ...
        }(CoreDevAdmin.Common.GridEditorDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (Northwind) {
        ...
        }(CoreDevAdmin.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return CoreDevAdmin.LanguageList.getValue();
            };
...
(function (CoreDevAdmin) {
    ...
    })(Authorization = CoreDevAdmin.Authorization || (CoreDevAdmin.Authorization = {}));
})(CoreDevAdmin || (CoreDevAdmin = {}));
var CoreDevAdmin;
(function (CoreDevAdmin) {
    var BasicSamples;
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.ProductDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.ProductGrid));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CoreDevAdmin.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CoreDevAdmin.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CoreDevAdmin.Northwind.OrderDialog();
                        ...
                        var chai = CoreDevAdmin.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CoreDevAdmin.Northwind.EmployeeRow.getLookup().items
        ...
        }(CoreDevAdmin.Northwind.OrderGrid));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.OrderDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    CoreDevAdmin.Northwind.CategoryService.Retrieve({
        ...
        }(CoreDevAdmin.Northwind.CategoryDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(CoreDevAdmin.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new CoreDevAdmin.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                CoreDevAdmin.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(CoreDevAdmin.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    CoreDevAdmin.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(CoreDevAdmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(CoreDevAdmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    CoreDevAdmin.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return CoreDevAdmin.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return CoreDevAdmin.Northwind.OrderService.baseUrl; };
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.SupplierDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(CoreDevAdmin.Northwind.SupplierGrid));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return CoreDevAdmin.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return CoreDevAdmin.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return CoreDevAdmin.Northwind.OrderService.baseUrl; };
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    CoreDevAdmin.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(CoreDevAdmin.Northwind.CustomerDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = CoreDevAdmin.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return CoreDevAdmin.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new CoreDevAdmin.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(CoreDevAdmin.Northwind.OrderDetailDialog));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Northwind.OrderDetailsEditor));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CoreDevAdmin.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CoreDevAdmin.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CoreDevAdmin.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreDevAdmin.Common.BulkServiceAction));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CoreDevAdmin.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CoreDevAdmin.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CoreDevAdmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CoreDevAdmin.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CoreDevAdmin.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CoreDevAdmin.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (CoreDevAdmin) {
    ...
    CoreDevAdmin.SelectableEntityGrid = SelectableEntityGrid;
})(CoreDevAdmin || (CoreDevAdmin = {}));
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return CoreDevAdmin.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return CoreDevAdmin.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(CoreDevAdmin.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = CoreDevAdmin.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            CoreDevAdmin.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return CoreDevAdmin.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return CoreDevAdmin.Northwind.ProductService.baseUrl; };
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return CoreDevAdmin.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return CoreDevAdmin.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return CoreDevAdmin.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return CoreDevAdmin.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (CoreDevAdmin) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CoreDevAdmin.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CoreDevAdmin.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CoreDevAdmin.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=CoreDevAdmin.Web.js.map